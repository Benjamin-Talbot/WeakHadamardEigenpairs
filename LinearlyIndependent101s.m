...
% LINEARLYINDEPENDENT101S  Generate the largest possible pairwise independent set of {-1, 0, 1} vectors in R^n.
%   Perms = LinearlyIndependent101s(n) returns a matrix of size n x numPerms, where numPerms = (3^n - 1)/2.
%   [Perms, numPerms] = LinearlyIndependent101s(n) also returns the number of vectors in the set.
